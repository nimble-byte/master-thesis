...
\textbf{So wird dick geschrieben} und \textit{so kursiv}. \textcitet[685]{janiesch2021machine} so wird Autor, Jahr und Seite zitiert. So wird in Klammern zitiert: \textcitep[685]{janiesch2021machine} oder (\textcites[685]{janiesch2021machine}[289]{herm2021symbolic}). So wird eine Internetquelle zitiert: \textcitet{diewi}. So wird im Dokument referenziert: Kapitel \ref{einleitung}, Gleichung \ref{eq:1} zeigt...
