...
\subsection{Cognition of AI Decisions} \label{ssec:cognition_ai_decisions}
...
\subsection{Psychology of Explanations} \label{ssec:psychology_explanations}
...
\subsection{AI Anthropomorphism} \label{ssec:ai_anthropomorphism}
