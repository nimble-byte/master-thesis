...
The following section provides an overview of the current state of research in \ac{XAI}, cognitive psychology, and the cognition of \ac{AI} users. \ac{XAI} is discussed in Section \ref{ssec:xai} by explaining terminology and reviewing explainability methods in \ac{XAI}. Section \ref{ssec:cognitive_psychology} presents relevant theories and findings from cognitive psychology. Section \ref{ssec:cognition_ai_users} discusses research into how users cognitively process \ac{AI} output in decision support systems and \acp{LLM}.

\subsection{Explainable AI} \label{ssec:xai}

This Section provides an overview of \ac{XAI} by defining key terminology in Section \ref{sssec:terminology} and discussing the state of research for explainability methods in Section \ref{sssec:explainability_methods}.
...
This Section provides an overview of relevant theories and findings from cognitive psychology.
...
This Section presents research into how users cognitively process AI output in decision support systems and \acp{LLM}. Since the field has only recently gained attention, the Section focuses on two recent studies in Section \ref{sssec:studies_ai_cognition}. It then discusses the psychology of explanations in Section \ref{sssec:psychology_explanations} and AI anthropomorphism in Section \ref{sssec:ai_anthropomorphism}.
