...
\begin{ctable}
    ...
    \begin{tabularx}{\textwidth}{l|X|l|l|l|l}
        ...
        \textbf{DP3} & DR1, DR3, DR4 & DR3, DR4 & DR3 & DR3 & DR3 \\
        \textbf{DP4} & DR1, DR5 & \textcolor{palettered}{DR3} & \textcolor{palettered}{DR3} & \textcolor{palettered}{DR3} & \textcolor{palettered}{DR3} \\
        \textbf{DP5} & DR2, DR4, (DR5) & DR2 & DR2 & \textcolor{palettered}{DR1} & \textcolor{paletteochre}{DR1}*, DR2 \\
        \textbf{DP6} & DR5 & \textcolor{paletteochre}{DR4}*, DR5* & \textcolor{palettered}{DR4} & DR5* & DR5* \\
    \end{tabularx}
    % LTeX: enabled=true
