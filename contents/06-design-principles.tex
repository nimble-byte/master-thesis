...
\begin{figure}[ht]
    ...
    \caption[Final design theory, including theory-derived design principles]{The complete design theory. \ac{DP} are organised to reduce the number of edge crossings. Theory-derived principles are highlighted in blue.}
