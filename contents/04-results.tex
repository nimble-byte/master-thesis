...
The frustration experienced by participants was significantly lower in group (E) with explanations ($M=2.571$) compared to group (B) without explanations ($M=12.200$), $U=33.500$, $p=0.005$. This indicates, that participants in group (E) felt less frustrated when using the chatbot compared to participants in group (B).
